...
const elements = {
  ...
  cameraMotionTitle: document.querySelector("#camera-motion-title"),
  cameraDurationLabel: document.querySelector("#camera-duration-label"),
  cameraDurationInput: document.querySelector("#camera-duration-input"),
  cameraEasingLabel: document.querySelector("#camera-easing-label"),
  cameraEasingInput: document.querySelector("#camera-easing-input"),
  cameraEasingLinear: document.querySelector("#camera-easing-linear"),
  cameraEasingEaseIn: document.querySelector("#camera-easing-ease-in"),
  cameraEasingEaseOut: document.querySelector("#camera-easing-ease-out"),
  cameraEasingEaseInOut: document.querySelector("#camera-easing-ease-in-out"),
