...
const translations = {
  en: {
    ...
    layerEditorEmptyText: "Load PNG files and click a layer card to edit speed, scale, and offsets.",
    selectedLayerLabel: "Selected Layer",
    selectedLayerMeta: "{width}x{height} px",
    layerDepthLabel: "Speed",
    layerScaleLabel: "Scale",
    layerOffsetXLabel: "Offset X",
    layerOffsetYLabel: "Offset Y",
    cameraTitle: "Motion",
  ...
  ru: {
    ...
    layerEditorEmptyText: "Загрузите PNG и нажмите на карточку слоя, чтобы настроить скорость, масштаб и смещения.",
    selectedLayerLabel: "Выбранный слой",
    selectedLayerMeta: "{width}x{height} px",
    layerDepthLabel: "Скорость",
    layerScaleLabel: "Масштаб",
    layerOffsetXLabel: "Смещение X",
    layerOffsetYLabel: "Смещение Y",
