...
const translations = {
  en: {
    ...
    effectSunGlowLabel: "Sun glow",
    effectOpacityLabel: "Opacity",
    effectRaySpeedLabel: "Ray speed",
    effectRayLengthLabel: "Ray length",
    effectRayCountLabel: "Rays count",
    effectRayThicknessLabel: "Thickness",
    effectRayBlurLabel: "Blur",
    effectRotationOffsetLabel: "Start rotation",
    effectRotationSpeedLabel: "Rotation speed",
    effectAdvancedTitle: "Ray settings",
    effectSunFlare: "Rays",
    layerOffsetXLabel: "X",
    layerOffsetYLabel: "Y",
    cameraTitle: "Settings",
    cameraMotionTypeLabel: "Motion Type",
    cameraAdvancedTitle: "Advanced",
    presetMoveLeft: "Move Left",
    presetMoveRight: "Move Right",
    presetZoomIn: "Zoom In",
    presetZoomInOut: "Zoom In, Pause, Zoom Out",
    presetCustom: "Custom",
    ...
    effectDetails: "Rays | Speed {depth} | Opacity {opacity}%",
    moveUp: "Up",
    moveDown: "Down",
    remove: "Remove",
    previewEmptyTitle: "Add png layers",
    previewEmptyText: "",
    statusInitial: "Load PNG files to begin editing.",
  ...
  ru: {
    ...
    effectSunGlowLabel: "Засвет",
    effectOpacityLabel: "Прозрачность",
    effectRaySpeedLabel: "Скорость лучей",
    effectRayLengthLabel: "Длина лучей",
    effectRayCountLabel: "Количество лучей",
    effectRayThicknessLabel: "Толщина",
    effectRayBlurLabel: "Размытие",
    effectRotationOffsetLabel: "Начальный поворот",
    effectRotationSpeedLabel: "Скорость вращения",
    effectAdvancedTitle: "Параметры лучей",
    effectSunFlare: "Лучи",
    layerOffsetXLabel: "X",
    layerOffsetYLabel: "Y",
    cameraTitle: "Настройки",
    cameraMotionTypeLabel: "Тип движения",
    cameraAdvancedTitle: "Дополнительно",
    presetMoveLeft: "Движение влево",
    presetMoveRight: "Движение вправо",
    presetZoomIn: "Увеличение",
    presetZoomInOut: "Увеличение, пауза, уменьшение",
    presetCustom: "Своя",
    ...
    effectDetails: "Лучи | Скорость {depth} | Прозрачность {opacity}%",
    moveUp: "Вверх",
    moveDown: "Вниз",
    remove: "Удалить",
    previewEmptyTitle: "Добавьте png слои",
    previewEmptyText: "",
    statusInitial: "Загрузите PNG-файлы, чтобы начать работу.",
    ...
    statusEffectAdded: "Лучи добавлены.",
