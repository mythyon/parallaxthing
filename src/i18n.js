...
const translations = {
  en: {
    ...
    addEffectButton: "Add sun",
    addDustButton: "Add particles",
    addCameraFlareButton: "Add camera flare",
    ...
    effectSunLensFlareLabel: "Lens flare",
    effectSunLensFlareSettingsTitle: "Lens flare settings",
    effectSunLensFlareIntensityLabel: "Intensity",
    effectSunLensFlarePathLengthLabel: "Path length",
    ...
    effectAdvancedTitle: "Sun settings",
    effectCameraFlareTitle: "Flare settings",
    effectCameraFlarePresetLabel: "Light preset",
    effectCameraFlarePresetWarm: "Warm light",
    effectCameraFlarePresetCool: "Cool light",
    effectSunFlare: "Sun",
    effectGoldDust: "Particles",
    effectCameraFlare: "Camera flare",
    effectCameraFlareRingCountLabel: "Circle count",
    effectCameraFlareAngleLabel: "Angle",
    effectCameraFlareAxisLengthLabel: "Axis length",
    effectCameraFlareRingScaleLabel: "Circle size",
    effectCameraFlareEndpointSpeedLabel: "End speed",
    effectCameraFlareBlurLabel: "Blur",
    effectCameraFlareStreakLabel: "Streak",
    layerOffsetXLabel: "X",
    layerOffsetYLabel: "Y",
    ...
    effectDetails: "Sun | Speed {depth} | Opacity {opacity}%",
    effectDustDetails: "Particles | Speed {depth} | Opacity {opacity}%",
    effectCameraFlareDetails: "Camera flare | Speed {depth} | Opacity {opacity}%",
    moveUp: "Up",
    moveDown: "Down",
    remove: "Remove",
    ...
    statusEffectAdded: "Sun added.",
    statusDustAdded: "Particles added.",
    statusCameraFlareAdded: "Camera flare added.",
  ...
  ru: {
    ...
    addEffectButton: "Добавить солнце",
    addDustButton: "Добавить частицы",
    addCameraFlareButton: "Добавить линзовые блики",
    ...
    effectSunLensFlareLabel: "Линзовые блики",
    effectSunLensFlareSettingsTitle: "Параметры линзовых бликов",
    effectSunLensFlareIntensityLabel: "Интенсивность",
    effectSunLensFlarePathLengthLabel: "Длина траектории",
    ...
    effectAdvancedTitle: "Параметры солнца",
    effectCameraFlareTitle: "Параметры линзовых бликов",
    effectCameraFlarePresetLabel: "Пресет света",
    effectCameraFlarePresetWarm: "Тёплый свет",
    effectCameraFlarePresetCool: "Холодный свет",
    effectSunFlare: "Солнце",
    effectGoldDust: "Частицы",
    effectCameraFlare: "Линзовые блики",
    effectCameraFlareRingCountLabel: "Количество кругов",
    effectCameraFlareAngleLabel: "Угол",
    effectCameraFlareAxisLengthLabel: "Длина оси",
    effectCameraFlareRingScaleLabel: "Размер кругов",
    effectCameraFlareEndpointSpeedLabel: "Скорость конца",
    effectCameraFlareBlurLabel: "Блюр",
    effectCameraFlareStreakLabel: "Линия",
    layerOffsetXLabel: "X",
    layerOffsetYLabel: "Y",
    ...
    effectDetails: "Солнце | Скорость {depth} | Прозрачность {opacity}%",
    effectDustDetails: "Частицы | Скорость {depth} | Прозрачность {opacity}%",
    effectCameraFlareDetails: "Линзовые блики | Скорость {depth} | Прозрачность {opacity}%",
    moveUp: "Вверх",
    moveDown: "Вниз",
    remove: "Удалить",
    ...
    statusEffectAdded: "Солнце добавлено.",
    statusDustAdded: "Частицы добавлены.",
    statusCameraFlareAdded: "Линзовые блики добавлены.",
